...
SECRET_KEY = 'django-insecure-oc7vv4fo+%jcugw8wv-$(lxvz4zaa2@_=$5_0@7z7xj8r62z13'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'blog.context_processors.get_all_tag',
            ],
        },
    },
]
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [ os.path.join(BASE_DIR,"static"),]   #siteye static klasörünü dahil etme
MEDIA_URL = '/media/'
